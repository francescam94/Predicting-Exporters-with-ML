...
load(Export_project/Data/exporting_history.RData')
```
...
```{r prob distrib}
png("tiff_pic/Fig3_exporting_score.png", width = 1000, height = 600,units="px",res=150)
...
Download locally the variable importance dataset generated in Step5 and Load it here
```{r load var_imp}
setwd('/your/directory/')
load("Server/var_imp.RData")
```
...
#Draw rthe graph
png("tiff_pic/Fig4_variable_inclusion_proportions.png", width = 1000, height = 600,units="px",res=120)
...
write_xlsx(firm_nuts,'Export_project/50_pctile_share.xlsx')
```
