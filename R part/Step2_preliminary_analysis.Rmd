...
png("/Users/francescamicocci/Desktop/tiff_pic/Fig2_Correlation_plot.png", width = 1200, height = 650,units="px")
...
```{r}
#Generate the final picture
tiff("/Users/francescamicocci/Documents/Export_project/Versione finale/corrplot.tiff", width = 1000, height = 550,units="px")
ggarrange(NULL,P1,NULL,labels.p,
           widths = c(-0.15,1, -0.25, 0.5), nrow = 1)
dev.off()
```
